...
// Consolidated
func consolidatedTitle() -> String {
    return "Consolidated"
}
func consolidatedParagraph() -> String {
...
// Wheel
func wheelTitle() -> String {
    return "Wheel"
}
func wheelParagraph() -> String {
